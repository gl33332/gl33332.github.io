...
excerpt:  文生图AI部署 1.域名:如(ai.138gl.com)，需要自己购买或注册免费域名。 2.登录Cloudflare 3.Wercker部署 复制Wercker代码➡️ 4.登录Wercker，创建新的Hello World项目，将复制的代码粘贴到项目中。 5.拉到代码第75行，const PASSWORDS = [‘admin123’]，将admin123替换为自己的密码。 6.左侧工具栏右键...
mathjax: true
tags:
- AI
title: AI免费部署文生图
toc: true
top: 2
updated: '2026-01-27T17:29:02.849+08:00'
---
...
11.如果有域名的话在此处选择 域或路由 点击右侧添加例如: [ai.138gl.com](https://) 点击添加。
